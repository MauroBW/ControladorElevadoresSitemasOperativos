...
public class ManejadorArchivosGenerico {
        ...
        public static String[] leerArchivoRutaRelativa(String nombreCompletoArchivo, boolean ignoreHeader) throws IOException {
        ...
        public static String[] leerArchivo(String nombreCompletoArchivo, boolean ignoreHeader) throws IOException {
            FileReader fr;
